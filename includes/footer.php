<footer class="bg-gray-800 text-white">
    <div class="container mx-auto px-4 py-12">
        <!-- Suppression des md:ml-auto pour un alignement naturel -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#events" class="text-gray-400 hover:text-white transition">Matchs</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><i class="fas fa-envelope mr-2"></i> contact@sportticket.com</li>
                    <li><i class="fas fa-phone mr-2"></i> +212 123 456 789</li>
